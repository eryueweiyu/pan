...
import (
	...
	"github.com/eryueweiyu/pan/account"
	"github.com/eryueweiyu/pan/conf"
	fileUtil "github.com/eryueweiyu/pan/utils/file"
...
const (
	SliceSizeDefault = 4 * 1024 * 1024
	SliceSizeVip     = 16 * 1024 * 1024
	SliceSizeSvip    = 32 * 1024 * 1024
...
func NewUploader(accessToken, path, localFilePath string, sliceSize int64) *Uploader {

	if sliceSize < SliceSizeDefault {
		sliceSize = SliceSizeDefault
	}
...
// 获取分片的大小
func (u *Uploader) getSliceSizeByUser(fileSize int64) (int64, error) {
	var sliceSize int64
